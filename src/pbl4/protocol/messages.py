...
_MESSAGE_TYPE_NAMES: dict[int, str] = {
    ...
    MESSAGE_TYPE_SHARD_READY: "SHARD_READY",
    MESSAGE_TYPE_SHARD_ERROR: "SHARD_ERROR",
    MESSAGE_TYPE_MODEL_MANIFEST: "MODEL_MANIFEST",
    MESSAGE_TYPE_MODEL_INIT: "MODEL_INIT",
    MESSAGE_TYPE_PARAMETER_META: "PARAMETER_META",
    MESSAGE_TYPE_PARAMETER_CHUNK: "PARAMETER_CHUNK",
    MESSAGE_TYPE_READY: "READY",
    MESSAGE_TYPE_STEP_START: "STEP_START",
    MESSAGE_TYPE_GRADIENT_META: "GRADIENT_META",
    MESSAGE_TYPE_GRADIENT_CHUNK: "GRADIENT_CHUNK",
    MESSAGE_TYPE_GRADIENT_END: "GRADIENT_END",
    MESSAGE_TYPE_PARAMETER_APPLIED: "PARAMETER_APPLIED",
    MESSAGE_TYPE_HEARTBEAT: "HEARTBEAT",
    MESSAGE_TYPE_EPOCH_END: "EPOCH_END",
